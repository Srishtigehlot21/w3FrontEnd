...
const useFetch = () => {
  ...
  const [state, setState] = useState({ loading: false, data: null, successMsg: "", errorMsg: "", });
  ...
  const fetchData = useCallback(async (config, otherOptions) => {
    ...
    try {
      ...
      setState({ loading: false, data, successMsg: data.msg || "success", errorMsg: "" });
      ...
      setState({ loading: false, data: null, errorMsg: msg, successMsg: "" });
